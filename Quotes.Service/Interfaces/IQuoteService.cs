...
namespace Quotes.Service.Interfaces
{
    public interface IQuoteService
    {
        ...
        Task<GenericResponse<QuoteRespDto>> UpdateQuote(int id, QuoteReqDto req,string userRole);
        Task<GenericResponse<string>> DeleteQuote(int id);
        Task<GenericResponse<List<QuotePaginatedRespDto>>> SearchQuote(QuoteFilter req, CancellationToken cancellationToken);
    }
}
